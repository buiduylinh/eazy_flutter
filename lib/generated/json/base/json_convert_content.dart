...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case MeetPeopleEntity:
			return meetPeopleEntityFromJson(data as MeetPeopleEntity, json) as T;			case MeetpeopleRequest:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case MeetPeopleEntity:
			return meetPeopleEntityToJson(data as MeetPeopleEntity);			case MeetpeopleRequest:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'MeetPeopleEntity':
			return MeetPeopleEntity().fromJson(json);			case 'MeetpeopleRequest':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'MeetPeopleEntity':
			return List<MeetPeopleEntity>();			case 'MeetpeopleRequest':
